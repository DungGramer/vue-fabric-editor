<template>
  <div>
    ...
    <div class="tool-box">
      ...
      <span @click="toggleDraw()" :class="isDrawing && 'bg'">
...
export default {
  ...
  methods: {
    ...
    toggleDraw() {
      // Enable drawing brush mode
      this.canvas.c.isDrawingMode = !this.canvas.c.isDrawingMode;
      this.isDrawing = !this.isDrawing;
      if (this.canvas.c.isDrawingMode) {
        this.canvas.c.freeDrawingBrush.color = '#000';
        this.canvas.c.freeDrawingBrush.width = 5;
      }
    },
  },
};
